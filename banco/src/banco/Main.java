...
public class Main {
    public static void main(String[] args) {
        ...
        // Criação das contas
        Conta conta1 = new Conta(cliente1.getNumero(), 23000.75, 3000.00);
        ...
        conta1.fazerOperacao(conta1, 200.00, "sacar");
        contaEstudantil1.fazerOperacao(conta1, 500.00, "sacar");
        contaEspecial1.fazerOperacao(conta1, 300.00, "sacar");
        System.out.println();
        
        // Depositando
        System.out.println("=== Depositando dinheiro nas contas ===");
        conta1.fazerOperacao(conta1, 20.00, "depositar");
        contaEstudantil1.fazerOperacao(conta1, 30.00, "depositar");
        contaEspecial1.fazerOperacao(conta1, 35.00, "depositar");
        System.out.println();
